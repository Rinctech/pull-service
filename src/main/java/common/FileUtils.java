...
public class FileUtils {
	...
	public static String readFileAsString(String uri) throws IOException {
	...
	public static File[]  listFilesInForder(String folderPath) throws IOException {
	...
	@Deprecated
	public static String loadFilePathToString(String fullPath) throws IOException {
